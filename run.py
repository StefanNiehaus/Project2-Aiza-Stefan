...
def simpleRun():
    ...
    h2 = net.addHost('router',
                     cls=Host,
                     defaultRoute=None,
                     mac='00:00:00:00:00:02')
    h3 = net.addHost('sender',
                     cls=Host,
                     defaultRoute=None,
                     mac='00:00:00:00:00:03')
    h1 = net.addHost('receiver',
                     cls=Host,
                     defaultRoute=None,
...
def RunTest(net):
    ...
    h1.cmd("./rdt2.0/obj/rdt_receiver 60001 FILE_RCVD 2> " + args.dir + "/" +
           args.name + "_receiver.csv &")

    print("Begin " + str(args.time) + " seconds of transmission")

    h2.cmd('./cellsim/sender/cellsim1 ./' + str(args.trace) + ' ' +
           str(args.trace) + ' 00:00:00:00:00:01 ' + str(args.loss) +
           ' router-eth0 router-eth1  2> c1 &')
    sleep(1)

    # pipe `rdt_sender` output to CSV
    h3.cmd("./rdt2.0/obj/rdt_sender 10.0.0.1 60001 small_file.bin 2> " +
           args.dir + "/" + args.name + "_sender.csv &")
